...
export class AddTargetUserToNotifications1743041311088 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_status_enum" AS ENUM('Pendente', 'Em andamento', 'Aguardando verificação', 'Atrasado', 'Finalizado', 'Devolvido', 'Reprovado')`,
        );
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_status_enum_old" AS ENUM('Pendente', 'Em andamento', 'Aguardando verificação', 'Finalizado', 'Devolvido', 'Reprovado')`,
        );
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "status" DROP DEFAULT`);
        await queryRunner.query(
