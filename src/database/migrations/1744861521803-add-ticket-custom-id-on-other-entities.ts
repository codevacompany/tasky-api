...
export class AddTicketCustomIdOnOtherEntities1744861521803 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "ticket_comment" ADD "ticketCustomId" character varying NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD "ticketCustomId" character varying NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE "notification" ADD "resourceCustomId" character varying`,
        );
    }
