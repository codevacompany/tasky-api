...
export class CreateTenant1744599038040 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "tenant" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "customKey" character varying NOT NULL, CONSTRAINT "PK_da8c6efd67bb301e810e56ac139" PRIMARY KEY ("id"))`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "verification_code" ADD "createdById" integer NOT NULL`,
        );
        ...
        await queryRunner.query(
            `CREATE UNIQUE INDEX "IDX_31a8cc51e06e84e27c49cd0e67" ON "ticket" ("tenantId", "customId") `,
        );
        await queryRunner.query(
