...
export class CreateTicketUpdate1744567862981 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "ticket_update" DROP CONSTRAINT "FK_75d1f67d31182f204e5c246e59d"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" DROP CONSTRAINT "FK_40e4144132be73232ff19eb6e3e"`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "department" RENAME COLUMN "created_at" TO "createdAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "department" RENAME COLUMN "updated_at" TO "updatedAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_comment" RENAME COLUMN "created_at" TO "createdAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_comment" RENAME COLUMN "updated_at" TO "updatedAt"`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket_update" RENAME COLUMN "created_at" TO "createdAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" RENAME COLUMN "updated_at" TO "updatedAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "verification_code" RENAME COLUMN "created_at" TO "createdAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "verification_code" RENAME COLUMN "updated_at" TO "updatedAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "notification" RENAME COLUMN "created_at" TO "createdAt"`,
        );
        await queryRunner.query(
            `ALTER TABLE "notification" RENAME COLUMN "updated_at" TO "updatedAt"`,
        );
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_update_action_enum" AS ENUM('criação', 'mudança_de_status', 'finalização', 'atualização', 'cancelamento')`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD "action" "public"."ticket_update_action_enum" NOT NULL`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_update_fromstatus_enum" AS ENUM('pendente', 'em_andamento', 'aguardando_verificação', 'Em_verificação', 'finalizado', 'cancelado', 'devolvido', 'reprovado')`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD "fromStatus" "public"."ticket_update_fromstatus_enum"`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_update_tostatus_enum" AS ENUM('pendente', 'em_andamento', 'aguardando_verificação', 'Em_verificação', 'finalizado', 'cancelado', 'devolvido', 'reprovado')`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD "toStatus" "public"."ticket_update_tostatus_enum"`,
        );
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_priority_enum" AS ENUM('baixa', 'média', 'alta')`,
        );
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_status_enum" AS ENUM('pendente', 'em_andamento', 'aguardando_verificação', 'Em_verificação', 'finalizado', 'cancelado', 'devolvido', 'reprovado')`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket" ALTER COLUMN "status" SET DEFAULT 'pendente'`,
        );
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."notification_type_enum" AS ENUM('abertura', 'comentário', 'atualização_de_status', 'atualização', 'cancelamento')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD CONSTRAINT "FK_40e4144132be73232ff19eb6e3e" FOREIGN KEY ("ticketId") REFERENCES "ticket"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD CONSTRAINT "FK_dae430f094c33e5fc452ea22ff2" FOREIGN KEY ("performedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "ticket_update" DROP CONSTRAINT "FK_dae430f094c33e5fc452ea22ff2"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" DROP CONSTRAINT "FK_40e4144132be73232ff19eb6e3e"`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."notification_type_enum_old" AS ENUM('Abertura', 'Comentário', 'Atualização de Status')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_status_enum_old" AS ENUM('Pendente', 'Em andamento', 'Aguardando verificação', 'Em verificação', 'Finalizado', 'Devolvido', 'Reprovado')`,
        );
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "status" DROP DEFAULT`);
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_priority_enum_old" AS ENUM('Baixa', 'Média', 'Alta')`,
        );
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "priority" DROP DEFAULT`);
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket_update" RENAME COLUMN "createdAt" TO "created_at"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" RENAME COLUMN "updatedAt" TO "updated_at"`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket_comment" RENAME COLUMN "createdAt" TO "created_at"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_comment" RENAME COLUMN "updatedAt" TO "updated_at"`,
        );
        await queryRunner.query(
            `ALTER TABLE "department" RENAME COLUMN "createdAt" TO "created_at"`,
        );
        await queryRunner.query(
            `ALTER TABLE "department" RENAME COLUMN "updatedAt" TO "updated_at"`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "verification_code" RENAME COLUMN "createdAt" TO "created_at"`,
        );
        await queryRunner.query(
            `ALTER TABLE "verification_code" RENAME COLUMN "updatedAt" TO "updated_at"`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD CONSTRAINT "FK_40e4144132be73232ff19eb6e3e" FOREIGN KEY ("ticketId") REFERENCES "ticket"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_update" ADD CONSTRAINT "FK_75d1f67d31182f204e5c246e59d" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
    }
}
