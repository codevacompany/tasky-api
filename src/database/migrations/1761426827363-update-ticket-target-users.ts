...
export class UpdateTicketTargetUsers1761426827363 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket" DROP CONSTRAINT "FK_ffbc3abfcba5686e3af922a39c4"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket" RENAME COLUMN "targetUserId" TO "currentTargetUserId"`,
        );
        await queryRunner.query(
            `CREATE TABLE "ticket_target_user" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" integer, "tenantId" integer NOT NULL, "updatedById" integer, "ticketId" integer NOT NULL, "userId" integer NOT NULL, "order" integer NOT NULL, CONSTRAINT "PK_2be2ef4562fefdfd908c8b9dee0" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
            `CREATE UNIQUE INDEX "IDX_5d99e5e312f1bbd7a68c405aba" ON "ticket_target_user" ("tenantId", "ticketId", "order") `,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_target_user" ADD CONSTRAINT "FK_6de2c4a4761be792e4618682938" FOREIGN KEY ("ticketId") REFERENCES "ticket"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_target_user" ADD CONSTRAINT "FK_d6070cef5dfd20ae1619a31da40" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket" ADD CONSTRAINT "FK_40ea5e549a523f17d97e909cb02" FOREIGN KEY ("currentTargetUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP VIEW "ticket_stats"`);
        await queryRunner.query(
            `ALTER TABLE "ticket" DROP CONSTRAINT "FK_40ea5e549a523f17d97e909cb02"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_target_user" DROP CONSTRAINT "FK_d6070cef5dfd20ae1619a31da40"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_target_user" DROP CONSTRAINT "FK_6de2c4a4761be792e4618682938"`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket" RENAME COLUMN "currentTargetUserId" TO "targetUserId"`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket" ADD CONSTRAINT "FK_ffbc3abfcba5686e3af922a39c4" FOREIGN KEY ("targetUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
