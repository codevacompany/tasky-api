...
export class AddUniqueConstraintToTenantCustomKey1751727022841 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "tenant" ADD CONSTRAINT "UQ_c33c1f2a1198fe31e1f3e1e674a" UNIQUE ("customKey")`,
        );
        await queryRunner.query(
            `ALTER TYPE "public"."payment_method_enum" RENAME TO "payment_method_enum_old"`,
        );
        await queryRunner.query(
            `CREATE TYPE "public"."payment_method_enum" AS ENUM('credit_card')`,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TYPE "public"."payment_method_enum_old" AS ENUM('credit_card', 'bank_slip', 'pix', 'bank_transfer')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "tenant" DROP CONSTRAINT "UQ_c33c1f2a1198fe31e1f3e1e674a"`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "permission" ADD "isActive" boolean NOT NULL DEFAULT true`,
        );
    }
}
