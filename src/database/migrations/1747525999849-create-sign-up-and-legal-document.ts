...
export class CreateSignUpAndLegalDocument1747525999849 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "tenant" ADD "termsAccepted" boolean NOT NULL DEFAULT false`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "tenant" ADD "privacyPolicyAccepted" boolean NOT NULL DEFAULT false`,
        );
        await queryRunner.query(`ALTER TABLE "tenant" ADD "privacyPolicyAcceptedAt" TIMESTAMP`);
        await queryRunner.query(
            `ALTER TABLE "tenant" ADD "privacyPolicyVersion" character varying`,
        );
    }
