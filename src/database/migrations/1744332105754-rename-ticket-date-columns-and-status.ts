...
export class RenameTicketDateColumnsAndStatus1744332105754 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket" ADD "isPrivate" boolean NOT NULL DEFAULT false`,
        );
        await queryRunner.query(
            `ALTER TABLE "ticket_comment" DROP CONSTRAINT "FK_3d08f54062e7f42b6ff1ca26b23"`,
        );
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_status_enum" AS ENUM('Pendente', 'Em andamento', 'Aguardando verificação', 'Em verificação', 'Finalizado', 'Devolvido', 'Reprovado')`,
        );
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."notification_type_enum" AS ENUM('Abertura', 'Comentário', 'Atualização de Status')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "ticket_comment" ADD CONSTRAINT "FK_3d08f54062e7f42b6ff1ca26b23" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."notification_type_enum_old" AS ENUM('Abertura', 'Comentário')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."ticket_status_enum_old" AS ENUM('Pendente', 'Em andamento', 'Aguardando verificação', 'Atrasado', 'Finalizado', 'Devolvido', 'Reprovado')`,
        );
        await queryRunner.query(`ALTER TABLE "ticket" ALTER COLUMN "status" DROP DEFAULT`);
        await queryRunner.query(
